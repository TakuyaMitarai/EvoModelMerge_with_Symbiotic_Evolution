...
# scaling
scale_factors = [1.2, 0.4, 1.4, 0.2] * 10  # レイヤーの数に合わせて調整
...
print(new_scale_factors)

class SCALE_GPT2Block2(SCALE_GPT2Block):
    def __init__(self, config, layer_idx=None, scaling_factors=None):
...
set_seed(46)
input_ids = tokenizer.encode("What color is an apple?", return_tensors="pt")
