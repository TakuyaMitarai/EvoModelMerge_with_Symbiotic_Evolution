...
class EvoMistralForCausalLM(nn.Module):
    ...
    def load_weights(self,
        ...
        for name, loaded_weight in hf_model_weights_iterator(
            ...
            if name in ["input_layers", "input_scales"] or re.match(r"model\.layers\.61\.", name) or re.match(r"model\.layers\.62\.", name) or re.match(r"model\.layers\.63\.", name):
                continue
        ...
        # Ensure that 'input_layers' and 'input_scales' are in the params_dict
        assert 'input_layers' in params_dict, "input_layers is missing in params_dict"
        assert 'input_scales' in params_dict, "input_scales is missing in params_dict"
